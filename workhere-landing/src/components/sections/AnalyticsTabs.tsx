...
const tabs = [
  {
    ...
    content: {
      ...
      points: [
        ...
        'Метрики по каналам и сегментам',
        'Отслеживание KPI команд',
        'Настраиваемые виджеты',
      ],
      stats: [
        { label: 'Время цикла', value: '12 дней', change: '-23%' },
  ...
  },
  {
    ...
    content: {
      heading: 'Детальный анализ воронки роста',
      points: [
        'Конверсия по этапам',
  ...
  },
  {
    ...
    icon: Users,
    title: 'Команда',
    description: 'Эффективность команд',
    content: {
      heading: 'Аналитика по командам',
      points: [
